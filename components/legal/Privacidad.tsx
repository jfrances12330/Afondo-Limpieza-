      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
          <p className="text-slate-600 dark:text-slate-400 italic">
            [Añada aquí la información sobre el tratamiento de datos de carácter personal conforme al RGPD]
          </p>
          ...
          <div className="h-96 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl flex items-center justify-center">
            <span className="text-slate-400">Espacio reservado para texto de privacidad</span>
          </div>
        </div>
      </div>
    </section>
