  ...
  return (
    <section className="relative flex min-h-[100svh] w-full flex-col justify-center items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl px-6 lg:px-12 pt-44 sm:pt-48 md:pt-40 lg:pt-32 pb-64 md:pb-48 flex flex-col items-center text-center">
        ...
        <h1 className="mb-6 md:mb-8 max-w-4xl text-3xl font-black leading-[1.1] tracking-tight text-white sm:text-6xl lg:text-7xl">
        ...
        <p className="mb-8 md:mb-12 max-w-3xl text-base font-medium leading-relaxed text-slate-200/90 sm:text-xl">
        ...
        <div className="flex w-full flex-col items-center justify-center gap-5">
          <button 
            ...
            className="group relative flex h-16 md:h-20 w-full max-w-md items-center justify-center gap-4 overflow-hidden rounded-2xl bg-primary px-10 transition-all duration-300 hover:bg-primary-dark hover:shadow-[0_20px_40px_rgba(26,26,255,0.4)] hover:-translate-y-1"
          >
            <span className="material-symbols-outlined text-white font-bold text-2xl md:text-3xl">calculate</span>
            <div className="flex flex-col items-start">
              <span className="text-lg md:text-xl font-black tracking-wide text-white uppercase leading-none">Calcular Presupuesto</span>
              <span className="text-[9px] md:text-[10px] font-bold text-white/70 uppercase mt-1 italic">Sin compromiso • Online</span>
            </div>
          </button>
          
          <p className="text-white/50 text-[10px] md:text-xs font-bold uppercase tracking-widest flex items-center gap-2">
      ...
      <div className="absolute bottom-0 z-20 w-full border-t border-white/10 bg-slate-900/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-around gap-4 px-4 py-6 md:py-8 md:justify-between lg:px-12">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[9px] font-black text-white uppercase tracking-widest text-left leading-tight">Certificado <br/> Oficial UNE</span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <span className="text-[9px] font-black text-white uppercase tracking-widest text-left leading-tight">Prevención <br/> de incendios</span>
          </div>
          <div className="hidden xs:flex items-center gap-3">
            ...
            <span className="text-[9px] font-black text-white uppercase tracking-widest text-left leading-tight">Garantía ante <br/> Sanidad</span>
          </div>
        </div>
      </div>
    </section>
