...
const SERVICIOS: Servicio[] = [
  {
    ...
    instalacion: 'Sistema completo de extracción de cocina profesional (campana con filtros, conductos y turbina) con acumulación de grasa por uso continuado.',
    metodologia: 'Desmontaje y desengrase de filtros, limpieza interior de conductos por registros y desengrase de turbina y carcasa, con prueba de funcionamiento final.',
    productos: 'Desengrasantes alcalinos profesionales aptos para uso alimentario y útiles de arrastre mecánico; residuos grasos gestionados según normativa.',
    conclusion: 'El sistema queda limpio y desengrasado, eliminando el principal foco de riesgo de incendio y restableciendo el rendimiento de aspiración. La actuación contribuye al cumplimiento del CTE DB-SI (seguridad frente a incendio) y del Reglamento (CE) 852/2004 de higiene alimentaria.',
  ...
  },
  {
    ...
    instalacion: 'Red de conductos de extracción de la cocina, con depósitos de grasa adheridos por el uso prolongado; actuación limitada a la tubería.',
    metodologia: 'Apertura de registros, desengrase de contacto y arrastre mecánico de las paredes interiores, con sellado posterior de las aberturas practicadas.',
    productos: 'Desengrasantes alcalinos profesionales de uso alimentario y útiles adaptados a la sección del conducto; sellado apto para su temperatura de trabajo.',
    conclusion: 'Los conductos quedan libres de grasa, mejorando el tiro y la evacuación de humos y reduciendo el riesgo de propagación de incendio, conforme al CTE DB-SI y al Reglamento (CE) 852/2004.',
  ...
  },
  {
    ...
    instalacion: 'Turbina/extractor centrífugo del sistema de extracción, con acumulación de grasa en rodete y carcasa que comprometía su rendimiento y equilibrado.',
    metodologia: 'Desmontaje completo, desengrase a fondo de rodete y carcasa, remontaje y prueba de funcionamiento verificando giro, caudal y ausencia de vibraciones.',
    productos: 'Desengrasantes alcalinos profesionales aptos para uso alimentario y, en su caso, juntas y fijaciones repuestas para garantizar estanqueidad y sujeción.',
    conclusion: 'La turbina recupera su rendimiento de aspiración sin vibraciones ni ruidos anómalos, eliminando la grasa que constituía un riesgo de incendio (CTE DB-SI · Reglamento (CE) 852/2004).',
  ...
  },
  {
    ...
    instalacion: 'Campana de cocina profesional con turbina centrífuga averiada (sin caudal o con ruido/vibración); el resto de la instalación se verifica apta.',
    metodologia: 'Corte de alimentación, desmontaje del motor averiado e instalación del nuevo grupo motor-turbina equivalente, con reconexión y prueba de funcionamiento.',
    productos: 'Turbina/motor de sustitución de caudal acorde al sistema, elementos de fijación y antivibración, material eléctrico y de sellado para la unión al conducto.',
    conclusion: 'Tras la sustitución el sistema queda operativo, restableciendo el caudal de aspiración y la correcta evacuación de humos conforme al CTE DB-HS3 y al Reglamento (CE) 852/2004.',
  ...
  },
  {
    ...
    instalacion: 'Red de conductos de evacuación con deficiencias de estanqueidad (fugas de humo u olores) en uno o varios tramos, que se corrigen mediante medidas correctoras.',
    metodologia: 'Localización de fugas, reparación de uniones y sustitución de los tramos dañados, con sellado resistente a alta temperatura y comprobación de la evacuación.',
    productos: 'Tramos de conducto, abrazaderas y uniones, juntas y sellante resistente a alta temperatura, y material de fijación y soporte.',
    conclusion: 'El sistema queda estanco y evacúa correctamente al exterior, eliminando las fugas detectadas conforme al CTE DB-HS3 y, frente a incendio, al CTE DB-SI, junto con la higiene del Reglamento (CE) 852/2004.',
  ...
  },
  {
    ...
    instalacion: 'Instalación nueva de un sistema completo de extracción para cocina profesional: campana, conductos, turbina y salida de evacuación al exterior.',
    metodologia: 'Montaje de campana y conductos con uniones estancas, instalación de la turbina y de la salida a cubierta/fachada, y puesta en marcha con comprobación de caudal y estanqueidad.',
    productos: 'Campana, conductos y accesorios, turbina, terminal de salida, fijaciones y antivibración, juntas y sellante resistente a alta temperatura, y material de conexión eléctrica.',
    conclusion: 'El sistema instalado queda operativo y estanco, conforme a las exigencias de ventilación del CTE DB-HS3, de seguridad frente a incendio del CTE DB-SI y de higiene del Reglamento (CE) 852/2004.',
  ...
  },
  {
    ...
    instalacion: 'Elementos del sistema de extracción generadores de ruido y vibraciones (turbina y, en su caso, campana y conductos), con molestias acústicas al entorno.',
    metodologia: 'Medición inicial, instalación de antivibratorios y material absorbente y, donde procede, conexiones flexibles y silenciadores, con medición final de la reducción.',
    productos: 'Materiales de aislamiento y absorción acústica, antivibratorios tipo silentblock y soportes elásticos, conexiones flexibles y, en su caso, silenciadores en línea.',
    conclusion: 'Se reduce de forma medible el nivel sonoro y las vibraciones transmitidas, orientado a situar la inmisión dentro de los límites de la normativa de contaminación acústica y las ordenanzas municipales aplicables.',
  ...
  },
  {
    ...
    instalacion: 'Conductos de evacuación en fachada o altura, no accesibles por medios convencionales, intervenidos mediante técnicas de acceso y posicionamiento por cuerda.',
    metodologia: 'Trabajos por cuerda con líneas de trabajo y seguridad independientes, reparando uniones y elementos afectados y restableciendo la estanqueidad del tramo en altura.',
    productos: 'EPI anticaídas y equipo de acceso por cuerda (arnés, cuerdas, dispositivos y anclajes) conforme a normativa, con uniones, juntas, sellante de alta temperatura y material de fijación.',
    conclusion: 'Se restablece la estanqueidad y la evacuación de humos del tramo, ejecutado con seguridad conforme al RD 2177/2004 y la norma EN 363, recuperando las condiciones del CTE DB-HS3.',
